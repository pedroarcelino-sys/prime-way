...
/*
    Smoke test local da leitura do estado compartilhado.
    Não altera o banco e usa sessão somente em memória.
*/

final class PrimewayEstadoSessaoMemoria implements SessionHandlerInterface
{
...
session_set_save_handler(
    new PrimewayEstadoSessaoMemoria(),
    true
);
